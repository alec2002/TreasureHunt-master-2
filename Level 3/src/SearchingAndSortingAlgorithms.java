...
public class SearchingAndSortingAlgorithms {
	...
	public void testSearch() {
		...
		System.out.println(Algorithm.findBrokenEgg(eggs));
		assertEquals(4, Algorithm.findBrokenEgg(eggs));
	}
	...
	System.out.println(Algorithm.countPearls(oysters));
	assertEquals(2, Algorithm.countPearls(oysters));
}
	...
	public void testFindMaxiumum() throws Exception {
		...
		System.out.println(Algorithm.findTallest(peeps));
		assertEquals(6.6, Algorithm.findTallest(peeps), 0.0);
	}
	...
	public void testFindMaxiumumString() throws Exception {
		...
		assertEquals("circumlocution", Algorithm.findLongestWord(words));
	}
